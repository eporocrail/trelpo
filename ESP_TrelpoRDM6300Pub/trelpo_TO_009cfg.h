...
static const char *ssid = "xxxxx";                           // ssid WiFi network
static const char *password = "pasword";                     // password WiFi network
static const char *topicPub = "rocnet/rs";                   // rocnet/rs for sensor
static const char *topicSub = "rocnet/rs";                   // rocnet/rs for sensor, in essence receiving published messages
