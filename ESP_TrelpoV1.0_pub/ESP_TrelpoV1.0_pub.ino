...
/*
/////// contents of decoder config file  /////////////////// user adjustble variables /////////////////////////////////////////
...
////////  contents of decoder config file  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
*/
...
void setup() {
  ...
  switch (hardwareId) {
    case 0:
      ...
      break;
    case 1:
      control = 3;                                           // control=3 is turnout loop
...
void loop() {
  ...
  if (control == 0) {                                      // set control =0 to transmit message
    ...
    if (hardwareId == 1) {
      control = 4;                                         // turnout loop after initialization step
      for (byte index = 0; index < turnoutNr; index++) {
